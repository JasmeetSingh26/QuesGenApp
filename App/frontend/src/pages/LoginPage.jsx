...
export default function LoginPage() {
  ...
  return (
    <div className="  md:mt-6 px-6 md:px-0 mx-auto grow flex justify-center items-center  overflow-hidden ">
      <div className="">
        ...
        <form action="" className="max-w-md mx-auto" onSubmit={handleLogin}>
          ...
          <div className="mt-2 mb-6 flex justify-between text-sm">
            <div className="items-center flex pl-1">
              ...
              />
              <label className="ml-2 text-xs md:text-sm">Remember me</label>
            </div>
